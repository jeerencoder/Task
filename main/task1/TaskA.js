...
const TaskA = () => {
    ...
    const handleDelete = async (postId) => {
        try {
            const updatedPosts = post.filter((p) => p.id !== postId);
    ...
    return (
        <SafeAreaView style={styles.safeAreaView}>
            <View style={{ flexDirection: "row", justifyContent: "space-around", }}>
                ...
                <View style={{ borderRadius: 10, backgroundColor: "green", justifyContent: "center", alignItems: "center", marginVertical: 10, paddingHorizontal: 10 }}>
                    <TouchableOpacity
